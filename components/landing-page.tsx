...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-6" ref={heroRef.ref}>
        <div className="container mx-auto max-w-6xl">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 transition-all duration-1000 delay-800 ${heroRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <Card className="glass-dark border-primary/20 text-center hover:scale-105 hover:border-primary/40 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 group">
            ...
            <Card className="glass-dark border-primary/20 text-center hover:scale-105 hover:border-accent/40 transition-all duration-300 hover:shadow-lg hover:shadow-accent/20 group delay-100">
              <CardContent className="pt-6">
            ...
            <Card className="glass-dark border-primary/20 text-center hover:scale-105 hover:border-primary/40 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 group delay-200">
              <CardContent className="pt-6">
      ...
      {/* Features Section */}
      <section className="py-20 px-6 bg-muted/20" ref={featuresRef.ref}>
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  className={`glass-dark border-primary/20 hover:border-primary/40 transition-all group hover:scale-105 hover:shadow-xl hover:shadow-primary/10 ${
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, index) => (
              <Card 
                key={index} 
                className={`glass-dark border-primary/20 relative overflow-hidden hover:scale-105 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 group ${
                  stepsRef.isVisible 
                    ? 'opacity-100 translate-y-0' 
                    : 'opacity-0 translate-y-10'
                }`}
      ...
      {/* Security & Trust */}
      <section className="py-20 px-6 bg-muted/20" ref={securityRef.ref}>
        <div className="container mx-auto max-w-6xl">
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-12 items-center transition-all duration-1000 ${securityRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <Card className="glass-dark border-primary/20 p-8 hover:scale-105 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10">
      ...
      <section className="py-20 px-6" ref={ctaRef.ref}>
        <div className="container mx-auto max-w-4xl">
          <Card className={`glass-dark border-primary/20 bg-gradient-to-br from-primary/10 to-accent/10 text-center p-12 hover:scale-105 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 ${ctaRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <CardHeader>
      ...
      {/* Footer */}
      <footer className="border-t border-border/50 py-8 px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="container mx-auto max-w-6xl">
